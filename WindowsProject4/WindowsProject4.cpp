...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_RBUTTONDOWN: {
        ...
        while (true) {
            int Number = rand() % 100;
            _stprintf_s(str, TEXT("Number=%d"), Number);
            SetWindowText(hWnd, str);
            MessageBox(0, TEXT("THIS ONE?"), TEXT("?"), MB_YESNO | MB_ICONINFORMATION);
            int id = MessageBox(0, TEXT("THIS ONE?"), TEXT("?"), MB_YESNO | MB_ICONINFORMATION);
            if (id==IDYES) {
                MessageBox(0, TEXT("End of the game"), TEXT("Alright"), MB_OK | MB_ICONINFORMATION);
                break;
            }
        }
    }
